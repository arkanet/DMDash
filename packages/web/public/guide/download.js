(function () {
  ...
  var isNativeAppShell = function () {
    ...
    if (
      typeof (capacitor === null || capacitor === void 0 ? void 0 : capacitor.isNativePlatform) ===
      "function"
    ) {
      return capacitor.isNativePlatform();
    }
    if (
      typeof (capacitor === null || capacitor === void 0 ? void 0 : capacitor.getPlatform) ===
      "function"
    ) {
  ...
  var updateInstallLinks = function () {
    document.querySelectorAll("a").forEach(function (anchor) {
      var isInstallLink =
        anchor.getAttribute("href") === installHref || anchor.href.endsWith(installHref);

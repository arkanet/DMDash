  ...
  return {
    plugins: [
      ...
      VitePWA({
        ...
        injectManifest: {
          globPatterns: ["**/*.{html,js,css,png,ico,webmanifest,json,woff2,txt}"],
          globIgnores: ["**/guide/**"],
        ...
        manifest: {
          ...
          short_name: "DMDash",
          description: "DarkMesh web dashboard for Meshtastic-compatible nodes.",
          start_url: "/",
          scope: "/",
          display: "standalone",
          ...
          shortcuts: [
            {
              name: "Connections",
              short_name: "Connect",
              description: "Open saved device connections.",
              url: "/connections",
              icons: [{ src: "/darkmesh-dashboard-192.png", sizes: "192x192" }],
            },
            {
              name: "Messages",
              short_name: "Messages",
              description: "Open DarkMesh messages.",
              url: "/messages",
              icons: [{ src: "/darkmesh-dashboard-192.png", sizes: "192x192" }],
            },
            {

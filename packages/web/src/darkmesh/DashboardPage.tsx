...
function DashboardCard({
  ...
  return (
    <details
      ...
      className="group rounded-lg border text-slate-900 shadow-sm dark:text-slate-100 border-slate-200/80 bg-white/90 backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-950/85"
    >
      <summary className="flex cursor-pointer list-none items-start justify-between gap-4 p-6 [&::-webkit-details-marker]:hidden">
        <div className="flex flex-col space-y-1.5">
          <h3 className="font-semibold uppercase tracking-[0.18em] text-sm text-slate-900 dark:text-white">
            {title}
          </h3>
          {description ? (
        ...
        <ChevronDown
          className="mt-0.5 h-5 w-5 shrink-0 text-slate-500 transition-transform group-open:rotate-180 dark:text-slate-400"
          aria-hidden
        />
      </summary>
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex w-full flex-col gap-6">
        ...
        <DashboardCard
          title="Mesh Stats"
          description="Track DarkMesh traceroute and app-side compression savings for this browser profile."
        >
          <label className="block text-sm">
            ...
            >
              <option value="app">App compression</option>
              <option value="remote">Firmware compression</option>
            </select>
          </label>
            ...
            <div className="rounded-lg border border-slate-200 bg-slate-50/80 px-4 py-4 text-sm dark:border-zinc-800 dark:bg-zinc-900/70">
              ...
              <dl className="grid gap-3">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <dd className="font-medium">{compressionMode === "app" ? "App" : "Firmware"}</dd>
                </div>
                <div className="flex items-center justify-between gap-3">
        ...
        >
          ...
          <div className="mt-2 text-xs text-slate-500">
            <div>
              BACKBONE: nodes whose role is <strong>ROUTER</strong>, <strong>ROUTER_LATE</strong> or{" "}
              <strong>CLIENT_BASE</strong>.
            </div>

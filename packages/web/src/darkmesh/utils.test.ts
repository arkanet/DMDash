...
describe("packet time helpers", () => {
  it("normalizes Date, ISO string, seconds and milliseconds packet rxTime values", () => {
    const iso = "2026-04-30T12:00:00.000Z";
    const ms = Date.parse(iso);

    expect(getPacketRxTimeMs(new Date(iso))).toBe(ms);
    expect(getPacketRxTimeMs(iso)).toBe(ms);
    expect(getPacketRxTimeMs(1_777_550_400)).toBe(1_777_550_400_000);
    expect(getPacketRxTimeMs(1_777_550_400_000)).toBe(1_777_550_400_000);
  });
});

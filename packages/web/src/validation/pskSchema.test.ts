...
function expectFirstIssueMessage(
  result:
    | ReturnType<ReturnType<ReturnType<typeof makePskHelpers>["stringSchema"]>["safeParse"]>
    | ReturnType<ReturnType<ReturnType<typeof makePskHelpers>["bytesSchema"]>["safeParse"]>,

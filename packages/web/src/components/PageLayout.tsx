    ...
    <ErrorBoundary FallbackComponent={ErrorPage}>
      <div className="flex h-full min-h-0 w-full flex-1 bg-background text-foreground overflow-hidden">
        ...
        <div className="flex h-full min-h-0 flex-1 flex-col min-w-0">
          ...
          <header
            className={cn(
              "shrink-0 border-b border-slate-300 dark:border-slate-700 max-md:sticky max-md:top-0 max-md:z-40 max-md:border-b-0",
              headerContent
          ...
          >
            ...
            {mobileHeaderContent ? (
              <div className="hidden max-h-[42dvh] overflow-y-auto bg-[#101010] px-3 py-3 max-md:block">
                {mobileHeaderContent}
              </div>
            ) : null}
          </header>

        ...
        <span className="text-sm mt-4">
          {normalizedError.message && (
            <>
              ...
              <p className="text-slate-400 break-words overflow-wrap">{normalizedError.message}</p>
            </> // TODO: Use Trans for the label and message together?
          )}
          {normalizedError.stack && (
            <>
              <label htmlFor="stack">{t("errorPage.stackTraceLabel")}</label>
              <p className="text-slate-400 break-words overflow-wrap">{normalizedError.stack}</p>
            </>
          )}
